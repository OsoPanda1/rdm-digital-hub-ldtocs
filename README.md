...
<p align="center">
  ...
  <a href="https://nodejs.org/">
    <img src="https://img.shields.io/badge/Node-20.x-3C873A?logo=node.js&logoColor=white" alt="Node.js 20.x">
  </a>
...
<p align="center">
  ...
  <a href="https://replit.com/">
    <img src="https://img.shields.io/badge/Platform-Replit_Autoscale-0f7bff?logo=replit&logoColor=white" alt="Platform: Replit Autoscale">
  </a>
  <a href="https://github.com/OsoPanda1/rdm-digital-hub-ldtocs/actions">
    <img src="https://img.shields.io/github/actions/workflow/status/OsoPanda1/rdm-digital-hub-ldtocs/ci.yml?label=CI&logo=github" alt="GitHub Actions CI">
  </a>
  <a href="./LICENSE">
    <img src="https://img.shields.io/badge/License-MIT-green" alt="License: MIT">
  </a>
  <a href="./LICENSE-PRCL.md">
    <img src="https://img.shields.io/badge/License-TAMV--PRCL-blueviolet" alt="License: TAMV-PRCL">
  </a>
</p>

<p align="center">
  <!-- Action / navigation badges -->
  <a href="https://github.com/OsoPanda1/rdm-digital-hub-ldtocs/tree/main/docs">
    <img src="https://img.shields.io/badge/Docs-Core_System_Docs-1D4ED8?logo=readme&logoColor=white" alt="Core System Docs">
  </a>
  <a href="https://github.com/OsoPanda1/rdm-digital-hub-ldtocs/tree/main/.agents/memory">
    <img src="https://img.shields.io/badge/Agents-Memory_Cell-7C3AED?logo=github&logoColor=white" alt="Agents Memory Cell">
  </a>
  <a href="https://github.com/OsoPanda1/rdm-digital-hub-ldtocs/tree/main/artifacts/api-server">
    <img src="https://img.shields.io/badge/API-Gateway_Express-111827?logo=express&logoColor=white" alt="API Gateway Express">
  </a>
</p>
...
- [Visión y Problemática Territorial](#🏔️-visión-y-problemática-territorial)  
- [Definición del Hub (Nodo Cero MD-X4)](#🛡️-definición-del-hub-nodo-cero-md-x4)  
- [Modelo de Gobernanza: 7 Federaciones TAMV](#🌐-modelo-de-gobernanza-las-7-federaciones-del-tamv)  
- [Arquitectura de Software y Monorepo](#🏗️-arquitectura-de-software-y-monorepo)  
...
## 🏔️ Visión y Problemática Territorial
...
## 🛡️ Definición del Hub (Nodo Cero MD-X4)

**RDM Digital Hub** es la primera infraestructura **digital soberana, federada, descentralizada y antifrágil** diseñada desde el territorio para el mundo. Construida sobre la arquitectura **TAMV MD-X4**, funciona como motor tecnológico de Mineral del Monte (Real del Monte), Hidalgo, ofreciendo:

- 🗺️ **Turismo Inteligente & Rutas Patrimoniales:** cartografía vectorial, clusterización dinámica de POIs y geofencing cultural.  
- 📻 **Transmisión Difusora TAMV 92.5 FM:** streaming de audio integrado al flujo web/móvil para la voz comunitaria.  
- 🛍️ **Comercio Soberano (Protocolo Alamexa):** conexión P2P entre habitantes, comerciantes y visitantes sin comisión extractiva.  
- 🤖 **Inteligencia Colectiva (Isabella AI Core):** asistente conversacional soberano con pipelines de conciencia ética y skills modulares.  
- 🏛️ **Gemelos Digitales y Telemetría:** fusión de capas geoespaciales y datos territoriales para preservación de memoria histórica.
...
## 🏗️ Arquitectura de Software y Monorepo
...
|------------------------|----------------------------------------|-------------------------------------------------------------------|
| **Frontend Framework** | React 19 + TypeScript 5.9              | Renderizado reactivo de alta velocidad y tipado estricto end-to-end. |
| **Build Tool**         | Vite 7.3.6                             | Compilación incremental *lightning-fast* y empaquetado optimizado. |
| **Estilos & UI**       | Tailwind CSS 4 + shadcn/ui             | Diseño accesible, responsivo y adaptado a identidades territoriales. |
| **Navegación & Estado**| React Router v6 + Zustand              | Enrutamiento con *lazy loading* y manejo de estado liviano.       |
| **Mapeo & Geoespacial**| Leaflet + Supercluster                 | Renderizado fluido de capas vectoriales con clusterización masiva. |
| **Backend Core**       | Express 5 sobre Node.js 20.x           | API Gateway ligera, asíncrona y tolerante a cargas concurrentes.  |
| **Base de Datos & Auth**| Supabase (PostgreSQL + Auth PKCE)     | Persistencia relacional con RLS, auth seguro y suscripciones.     |
| **Infra & Despliegue** | Replit Autoscale + pnpm workspaces     | Contenedores autónomos con auto-escalado dinámico, sin terceros propietarios. |
...
|-------------------------------|:----------------:|--------------------------------------------------------------------|
| Portal Turístico Interactivo | 78%              | Interfaz principal, catálogo de patrimonio, eventos y rutas.      |
| Motor Mapas Geoespaciales    | 85%              | Clusterización de POIs con Leaflet, capas de telemetría y modo offline. |
| Gestión de Identidad (Auth)  | 90%              | Autenticación PKCE mediante Supabase, roles RBAC y pasaporte digital. |
| Isabella AI Engine (F6)      | 65%              | Pipeline de respuesta consciente, evaluación ética, API REST soberana. |
| Bus de Federación YUN        | 30%              | Protocolo de sincronización P2P entre los 7 nodos territoriales TAMV. |
| Capa de Seguridad PQC (F7)   | 35%              | Cifrado resiliente a computación cuántica y sanitización de fronteras. |
...
- 📍 **Exploración Geolocalizada:** check-ins verificados en POIs históricos y comercios locales.  
- 📜 **Misiones Narrativas:** rutas dinámicas tematizadas (por ejemplo, "Ruta del Minero", "Ruta de la Plata", "Ruta de las Leyendas").  
- 🏆 **Rangos de Prestigio:**
...
- 🎁 **Recompensas Tangibles:** moneda blanda (RDM Points) canjeable por beneficios reales en comercios participantes.  
- ⏳ **Temporadas Trimestrales (90 días):** leaderboards con premiación en festivales locales.

> La especificación completa vive en `features/gamification/GAME_DESIGN_RDM_PHYGITAL.md`.

---

## 🚀 Despliegue e Infraestructura Soberana (Replit Native)

El proyecto ha completado la transición total hacia arquitectura **Replit-Native**, eliminando dependencias de Vercel, Netlify, Lovable.
