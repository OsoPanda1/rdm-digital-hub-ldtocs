import { RdmSceApiBridge, IsabellaCognitiveInterceptor } from "./integration/api-bridge"
...
export class RdmSceEngine {
  ...
  public readonly isabella: IsabellaCognitiveInterceptor
  ...
  constructor(nodeId = "rdm-sce-node-001") {
    ...
    this.isabella = this.api.getIsabella()
  }
  ...
  start(): void {
    ...
    const localMmdb = new LocalMmdbProvider("maxmind_local_offline", "/data/geoip/rdm.mmdb", {
      ...
      "10.0.0.1": { countryCode: "MX", regionCode: "HGO", city: "Mineral del Monte", latitude: 20.1383, longitude: -98.6736, asn: 13039, isp: "Red_Mesh_TAMV_Local" },
    })
    ...
    rdmMesh.loadMesh([
      ...
      { ipRange: "172.16.0.0/12", location: { lat: 20.1398, lng: -98.6727 }, nodeId: "RDM-EDGE-NODE-F3", federationId: 3 },
      { ipRange: "192.168.0.0/16", location: { lat: 20.1398, lng: -98.6727 }, nodeId: "RDM-EDGE-NODE-F5", federationId: 5 },
    ])
