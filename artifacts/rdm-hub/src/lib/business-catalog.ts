...
export const RDM_BUSINESS_CATEGORIES: BusinessCategory[] = [
  { id: "gastronomia", name: "Gastronomía", description: "Cocina local, cafeterías y panadería artesanal.", icon: "ðŸ½ï¸" },
  { id: "artesanias", name: "Artesanías", description: "Textiles, piezas decorativas y arte popular.", icon: "ðŸ§µ" },
  { id: "platerias", name: "Platerías", description: "Joyería de plata y talleres especializados.", icon: "ðŸ’" },
  { id: "tiendas-miscelaneas", name: "Tiendas & Misceláneas", description: "Comercio de conveniencia y variedad diaria.", icon: "ðŸ›ï¸" },
  { id: "servicios-turisticos", name: "Servicios Turísticos", description: "Recorridos, guías, racers, cuatrimotos y camioncitos turísticos.", icon: "ðŸ§­" },
  { id: "bares", name: "Bares", description: "Mixología, música y ambiente nocturno.", icon: "ðŸ¸" },
  { id: "hospedaje", name: "Hospedaje", description: "Hoteles, cabañas y cuartos disponibles.", icon: "ðŸ›ï¸" },
  { id: "otros", name: "Otros Comercios", description: "Ropa, verdura, aseo del hogar, zapaterías, papelerías y salones.", icon: "ðŸª" },
  { id: "emergencias", name: "Emergencias", description: "Cerrajeros, dentales, médicos, mecánicos y talacheras.", icon: "ðŸš¨" },
  { id: "nuevas-secciones", name: "Nuevas Secciones", description: "Espacio para categorías futuras no contempladas aún.", icon: "âž•" },
];
