...
export const MAP_LAYER_PRESETS = {
  tourism: [
    ...
    { id: 'satellite', name: 'SatÃ©lite', type: 'base' as const, visible: false },
    { id: 'poi-markers', name: 'Puntos de InterÃ©s', type: 'overlay' as const, visible: true },
    { id: 'routes', name: 'Rutas TurÃ­sticas', type: 'overlay' as const, visible: true },
  ...
  adventure: [
    { id: 'topo', name: 'TopogrÃ¡fico', type: 'base' as const, visible: true },
    { id: 'satellite', name: 'SatÃ©lite', type: 'base' as const, visible: false },
    { id: 'trails', name: 'Senderos', type: 'overlay' as const, visible: true },
    { id: 'elevation', name: 'Perfil de ElevaciÃ³n', type: 'overlay' as const, visible: false },
    { id: 'poi-markers', name: 'Puntos de InterÃ©s', type: 'overlay' as const, visible: true },
  ],
  default: [
    { id: 'osm', name: 'OpenStreetMap', type: 'base' as const, visible: true },
