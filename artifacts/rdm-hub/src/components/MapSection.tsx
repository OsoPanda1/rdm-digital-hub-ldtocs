    ...
    twins.forEach((twin) => {
      ...
      const popupContent = `
        ...
        ">
          ...
          ${twin.properties.narrative ? `<div style="font-size:12px; color:#475569; line-height:1.4; margin-bottom:8px;">${(twin.properties.narrative as string).substring(0, 140)}â€¦</div>` : ""}
