        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-16 lg:p-24">
          ...
          >
            ...
            <h2 className="font-display text-4xl font-bold leading-[0.9] md:text-7xl">
              Sabores que cruzan
              <br />
              <span className="text-accent">ocÃ©anos</span>
            </h2>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          <div>
            <p className="mb-6 font-body text-lg leading-relaxed text-foreground/70">
              El paste llegÃ³ a Real del Monte en 1824 con la migraciÃ³n minera cornish. NaciÃ³ como comida
              portÃ¡til para el socavÃ³n y hoy es emblema de la cocina hidalguense. En el centro histÃ³rico,
            ...
            <p className="mb-10 font-body text-base leading-relaxed text-foreground/70">
              Esta secciÃ³n prioriza precios reales de paste tradicional para evitar expectativas errÃ³neas en visitantes.
              Otros productos como barbacoa o bebidas mantienen sus rangos propios segÃºn porciÃ³n y temporada.
            </p>
