  ...
  >
    <div className="space-y-8">
      ...
      <Section title="Segmentación de clientes y rutas de adopción">
        ...
        <div className="space-y-3">
          {[
            ...
            { route: "Ruta Institucional", path: "Premium â†’ Advance â†’ Enterprise", desc: "Universidades y organizaciones que inician con evaluación, lanzan pilotos y escalan a despliegues federados." },
      ...
      <Section title="Modelo de negocio por membresía">
        <div className="space-y-3">
          {[
            ...
            { tier: "Premium (~7â€“15 USD/mes)", desc: "Dashboards básicos, contenidos ampliados, módulos introductorios de UTAMV. Para profesionales individuales y microempresas." },
            { tier: "Devs (~25â€“50 USD/mes)", desc: "Kit APIs con sandbox, documentación avanzada, acceso a NOAâ€‘TAMV en lectura, Social Core. Para desarrolladores y equipos técnicos." },
            { tier: "Advance (~250â€“500 USD/mes)", desc: "Monitoreo avanzado, integración con NOA y Social Core, configuración de nodos, soporte prioritario. Para instituciones medianas." },
      ...
      <Section title="Narrativa de marca">
        <div className="rounded-lg border border-primary/20 bg-primary/5 p-5">
          <p className="text-sm text-muted-foreground leading-relaxed">
            TAMV MDâ€‘X4 nace de la convicción de que la <strong className="text-primary">soberanía digital es un derecho</strong>,
