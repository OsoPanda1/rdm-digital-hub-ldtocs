...
const MOCK_CAMPAIGNS = [
  {
    ...
    title: "Menú del Día â€” Pastes Auténticos",
  ...
  },
  {
    ...
    title: "Colección verano 2026 â€” Plata Real del Monte",
...
const MOCK_BANNERS = [
  ...
  { id: "b3", campaign_id: "c3", business: "Platería Reyes",         tagline: "Joyería artesanal â€” Plata de Real",      cta: "Ver colección", active: false, slot: null },
];
    ...
    <div className="flex items-center gap-4 p-4 rounded-xl border border-white/5 hover:border-white/10 transition-all bg-white/2 hover:bg-white/5">
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-white/40 mt-0.5" style={{ fontFamily: "var(--font-body)" }}>
          {campaign.business} · {campaign.start} â†’ {campaign.end}
        </p>
      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="ej. Menú del Día â€” Julio 2026"
