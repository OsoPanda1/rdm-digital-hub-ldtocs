...
const domainData: Record<string, { title: string; tipo: string; proposito: string; funciones: string[]; integraciones: string[] }> = {
  "id-nvida": {
    ...
    funciones: [
      ...
      "Verificación sin exposición (Zeroâ€‘Knowledge Proofs)",
  ...
  utamv: {
    ...
    integraciones: ["Metaverso MDâ€‘X4 (entornos)", "Isabella AI (tutorización)", "IDâ€‘NVIDA (certificación)"],
  },
  metaverso: {
  ...
  economia: {
    ...
    integraciones: ["EOCT Blockchain (ledger)", "IDâ€‘NVIDA (identidad)", "Isabella AI (análisis)"],
  },
  seguridad: {
    title: "Seguridad â€” Guardianías",
    tipo: "Guardianía",
    proposito: "Protección integral mediante ANUBIS, HORUS, TENOCHTITLAN y módulos Zeroâ€‘Trust.",
    funciones: [
      "ANUBIS: honeypots y defensa proactiva",
      "HORUS: monitoreo multi-sensorial",
      "TENOCHTITLAN: resiliencia de infraestructura",
      "Zeroâ€‘Trust cultural integrado al código",
    ],
...
const accessMatrix = [
  ...
  { feature: "Acceso a NOAâ€‘TAMV (operación)", free: false, premium: false, devs: false, advance: true, enterprise: true },
        ...
        <>
          ...
          <Section title="Modelo económico">
            <div className="space-y-3">
              {[
                { tier: "Free â€” 0 MXN/mes", desc: "Acceso pedagógico y exploratorio. Lectura completa de la wiki, Isabella básica, casos de uso públicos. Puerta de entrada educativa." },
                { tier: "Premium â€” ~7â€“15 USD/mes", desc: "Usuarios individuales y microempresas. Dashboards básicos, contenidos ampliados, módulos introductorios de UTAMV, reportes." },
                { tier: "Devs â€” ~25â€“50 USD/mes", desc: "Acceso técnico intensivo. Kit de APIs completo con sandbox, documentación avanzada, ejemplos NOAâ€‘TAMV, Social Core." },
                { tier: "Advance â€” ~250â€“500 USD/mes", desc: "Instituciones medianas y universidades. Monitoreo avanzado, integración parcial con NOA y Social Core, configuración de nodos, soporte prioritario." },
                { tier: "Enterprise â€” Contrato anual (a negociar)", desc: "Ecosistemas multi-nodo, despliegues federados llave en mano, gobernanza compartida, integración con infra propia, SLA dedicado." },
              ].map((t) => (
