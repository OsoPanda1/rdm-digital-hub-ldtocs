  ...
  return (
    <WikiPage
      title="Sistema TENOCHTITLAN"
        subtitle="Arquitectura Defensiva Avanzada â€” Seguridad Multicapa Civilizatoria"
      >
        {/* Hero Banner */}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="text-xs text-muted-foreground">{c.subtitle} â€” {c.totalCapas}</span>
                    </div>
                  </div>
                </motion.button>
              );
