...
export default function PatrimonioCulturalPage() {
  ...
  return (
    <RDMLayout>
      <SEOMeta title="Patrimonio Cultural â€” Real del Monte" description="Museos, monumentos, hitos visuales y patrimonio natural de Real del Monte. Guía completa de activos históricos y culturales." />
