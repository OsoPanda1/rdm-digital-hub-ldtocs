...
const FEDERACIONES = [
  {
    id: "DEKATEOTL",
    name: "Dekateotlâ„¢",
    subtitle: "Gobernanza Ã‰tica y Lógica Narrativa",
    stack: "LangGraph + SHAP (Explainable AI)",
    desc: "Orquestador de axiología. Utiliza valores de Shapley para desglosar la toma de decisiones de la IA, garantizando que cada respuesta de Isabella IAâ„¢ sea ética, transparente y auditable en tiempo real.",
    icon: Brain,
  ...
  },
  {
    ...
    desc: "Capa de manifestación visual y táctil. Proyecta a Isabella IAâ„¢ en entornos de realidad extendida con alta fidelidad (\"Crystal Glow\"), permitiendo una interacción inmersiva con el patrimonio.",
    icon: Palette,
...
const Arquitectura = () => (
  <WikiPage
    title="Arquitectura Heptafederada"
        subtitle="Núcleo de Inteligencia Territorial â€” Soberanía Digital de Clase Mundial"
      >
        {/* Hero Banner */}
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        Explicable (XAI) y Trazabilidad Distribuida â€” demostrando que la innovación de clase mundial puede
    ...
    <Section title="Isabella IAâ„¢ â€” Núcleo Cognitivo Nómada">
      <div className="rounded-xl border border-border/60 bg-gradient-to-br from-card to-muted/30 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">No es un chatbot â€” es un sistema de interpretación territorial</p>
          </div>
        </div>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Isabella IAâ„¢ nace de una investigación de 21,600 horas dedicada a humanizar la inteligencia digital.
    ...
    <Section title="Validación Científica">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          { title: "Antifragilidad", desc: "Marco conceptual de Nassim Taleb â€” el sistema mejora ante la presión", icon: Zap },
        ].map((item) => (
