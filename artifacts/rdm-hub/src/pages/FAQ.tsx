...
const FAQ_GROUPS: FaqGroup[] = [
  {
    ...
    items: [
      ...
      { q: "¿Cómo uso el mapa interactivo?", a: "En la página de inicio, sección Mapa, puedes ver sitios, museos, ecoturismo y comercios. Usa el botón â€œCentrar en míâ€ para activar tu geolocalización y filtra por categoría y tipo de lugar." },
        ...
        <div className="container mx-auto max-w-3xl px-6">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              placeholder="Busca por tema: pastes, membresía, mapa, leyendasâ€¦"
          ...
          {totalResults === 0 ? (
            <div className="glass-surface-strong p-8 text-center">
              <p className="mb-4 text-sm text-muted-foreground">No encontramos artículos para â€œ{query}â€.</p>
