...
import elSenaladoMp3 from "@/assets/musica/el_seÃ±alado.mp3"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-[#A7F300]/30 bg-[#A7F300]/10 px-4 py-1.5 text-[9px] uppercase tracking-[0.25em] text-[#A7F300] mb-4">
            ...
            <span>Ecos Musica â€” Sistema Sonoro Territorial</span>
          </div>
          <h2
    ...
    <RDMLayout>
      ...
      <section className="relative pt-20 pb-4 px-6 md:px-16 bg-[hsl(220_30%_6%)]">
        <div className="max-w-5xl mx-auto">
          <Link
            to="/podcast"
            className="group flex items-center justify-between gap-4 px-5 py-4 rounded-2xl border border-green-500/25 bg-green-500/6 hover:border-green-500/50 hover:bg-green-500/10 transition-all duration-300"
          >
      ...
      >
        {donating ? (
          ...
          <>
            ...
            Donar $
            {currentAmount.toLocaleString() || "â€¦"}
          </>
        )}
      </button>
