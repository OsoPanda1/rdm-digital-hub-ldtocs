...
export default function Feed() {
  ...
  return (
    <RDMLayout>
      <SEOMeta {...PAGE_SEO.mapa} title="Feed Comunitario â€” RDM Digital" description="Publicaciones, historias y recuerdos compartidos por la comunidad de Real del Monte." />
