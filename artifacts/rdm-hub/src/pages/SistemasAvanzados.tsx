      ...
      <TabsContent value="socialcore" className="space-y-6 mt-6">
        ...
        <Section title="Relaciones y dinámicas">
          <div className="space-y-3">
            {[
              ...
              { icon: Shield, title: "Penalizaciones", desc: "Sistema de sanciones graduales por violación del Códice Maestro: advertencia â†’ restricción temporal â†’ suspensión â†’ expulsión. Apelable ante el consejo de guardianes." },
            ].map((r) => (
        ...
        <Section title="Estado del módulo">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-yellow-500/30 bg-yellow-500/5">
            ...
            <span className="text-sm text-yellow-500 font-medium">En progreso â€” Diseño conceptual completado, implementación pendiente</span>
          </div>
