...
export const b2bPlans = [
  ...
  { sector: "Pasterías/Platerías", price: 400, businesses: 15, icon: "ðŸ¥§" },
  { sector: "Artesanías", price: 350, businesses: 22, icon: "ðŸŽ¨" },
  { sector: "Tiendas", price: 250, businesses: 18, icon: "ðŸª" },
  { sector: "Góndolas/Semifijos", price: 150, businesses: 35, icon: "ðŸ›’" },
];
