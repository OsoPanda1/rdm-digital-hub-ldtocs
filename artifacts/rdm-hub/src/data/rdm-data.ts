 ...
 */
// ============================================================
// RDM Digital â€” Datos Reales de Real del Monte, Hidalgo, México
// ============================================================
...
export const places = [
  ...
  { id: "bosque-pinos", name: "Bosque de Pinos", category: "nature", lat: 20.1556, lng: -98.6856, description: "Ãrea natural para senderismo a 2,700m de altitud. Bosque de oyamel y pino con aire puro de montaña y senderos marcados." },
  { id: "cristo-rey", name: "Cristo Rey (Peña del Zumate)", category: "viewpoint", lat: 20.1460, lng: -98.6690, description: "Monumento icónico en la cima de la peña, con vistas panorámicas de 360Â° del pueblo y las montañas circundantes." },
...
export const routes = [
  { id: "ruta-patrimonio", name: "Ruta del Patrimonio", description: "Caminata por los sitios históricos más importantes del pueblo, desde la plaza hasta el panteón inglés.", difficulty: "Fácil", duration: "1.5 hrs", distance: "2.5 km", icon: "ðŸ›ï¸", color: "from-secondary to-yellow-300", points: ["Plaza de la Constitución", "Parroquia de la Asunción", "Panteón Inglés", "Calles Coloniales"] },
  { id: "ruta-gastronomica", name: "Ruta Gastronómica", description: "Recorrido por los mejores restaurantes, cafés y pasterías. Prueba el paste original y la barbacoa hidalguense.", difficulty: "Fácil", duration: "1 hr", distance: "1.8 km", icon: "ðŸ½ï¸", color: "from-heritage-warm to-orange-300", points: ["Mina Coffee House", "Pastelería del Pueblo", "La Casa de los Tacos", "Los Portales"] },
  { id: "ruta-miradores", name: "Ruta de los Miradores", description: "Caminata hasta los mejores puntos panorámicos del pueblo y la sierra.", difficulty: "Moderada", duration: "2 hrs", distance: "4.0 km", icon: "ðŸ”ï¸", color: "from-primary to-cyan-300", points: ["Parque Central", "Vista del Peñón", "Mirador del Atardecer"] },
  { id: "ruta-aventura", name: "Ruta de Aventura", description: "Senderismo por el bosque con obstáculos naturales y cascadas ocultas.", difficulty: "Difícil", duration: "3 hrs", distance: "8.5 km", icon: "â›°ï¸", color: "from-emerald-400 to-green-300", points: ["Bosque de Pinos", "Cascada Oculta", "Mirador del Peñón"] },
  { id: "ruta-nocturna", name: "Ruta Nocturna Mágica", description: "Caminata nocturna iluminada con historias de fantasmas y leyendas mineras.", difficulty: "Fácil", duration: "1.5 hrs", distance: "2.2 km", icon: "ðŸŒ™", color: "from-purple-400 to-indigo-400", points: ["Plaza de la Constitución", "Calles Coloniales", "Panteón Inglés", "Parroquia"] },
  { id: "ruta-romantica", name: "Ruta Romántica", description: "Paseo bajo la neblina por los rincones más encantadores del pueblo. Ideal para parejas.", difficulty: "Fácil", duration: "1 hr", distance: "1.5 km", icon: "ðŸ’•", color: "from-pink-400 to-rose-300", points: ["Plaza Principal", "Calles Empedradas", "Mirador del Atardecer"] },
  { id: "ruta-cervecera", name: "Ruta Cervecera", description: "Visita a los bares y establecimientos con cerveza artesanal local de montaña.", difficulty: "Fácil", duration: "2 hrs", distance: "1.2 km", icon: "ðŸº", color: "from-amber-400 to-yellow-300", points: ["Bar El Portal", "Centro Histórico", "Plaza Principal"] },
  { id: "ruta-platera", name: "Ruta Platera", description: "Recorrido por los talleres de plata y joyería artesanal de la región.", difficulty: "Fácil", duration: "1.5 hrs", distance: "2.0 km", icon: "ðŸ’Ž", color: "from-silver-chrome to-gray-300", points: ["Talleres de Plata", "Artesanías RDM", "Mercado Artesanal"] },
  { id: "ruta-ecoturismo", name: "Ruta Ecoturística", description: "Contacto con la naturaleza: bosques de oyamel, fauna local y aire puro a 2,700m.", difficulty: "Moderada", duration: "2.5 hrs", distance: "5.0 km", icon: "ðŸŒ²", color: "from-emerald-500 to-teal-300", points: ["Bosque de Pinos", "Manantiales", "Miradores naturales"] },
];
