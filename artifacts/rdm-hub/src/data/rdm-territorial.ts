...
export const ESTACIONAMIENTOS: Estacionamiento[] = [
  ...
  { id: "EST-02", nombre: "Don Fredy", ubicacion: "La Trinidad 147, La Quebradilla", lat: 20.13846, lng: -98.67047, capacidad: "Alta â€” Acceso rápido al centro", tipo: "alta" },
  { id: "EST-03", nombre: "Estacionamiento Mayor", ubicacion: "Av. Juárez (Entrada Principal)", lat: 20.13780, lng: -98.67550, capacidad: "Masiva â€” Principal receptáculo", tipo: "masiva" },
  ...
  { id: "EST-06", nombre: "Hotel Paraíso Real", ubicacion: "Av. Hidalgo (Centro Histórico)", lat: 20.14080, lng: -98.67250, capacidad: "Baja â€” Exclusivo pernocta", tipo: "baja" },
...
export const MUSEOS_SITIO: SitioPatrimonial[] = [
  { id: "MUS-01", nombre: "Mina de Acosta", categoria: "museo", descripcion: "Recorrido subterráneo de 400m. Conserva maquinaria de vapor y eléctrica.", lat: 20.13520, lng: -98.66980, horario: "10:00â€“18:00 (Mar-Dom)", icono: "â›ï¸", destacado: true },
  { id: "MUS-02", nombre: "Mina La Dificultad", categoria: "museo", descripcion: "Hito de la transición tecnológica minera.", lat: 20.14595, lng: -98.67194, horario: "10:00â€“18:00 (Mié-Dom)", icono: "ðŸ—ï¸" },
  ...
  { id: "MUS-04", nombre: "Casa Grande (Archivo Histórico)", categoria: "museo", descripcion: "Memoria documental de la empresa minera.", lat: 20.14070, lng: -98.67280, icono: "ðŸ“œ" },
  { id: "MUS-05", nombre: "Museo del Paste", categoria: "museo", descripcion: "Legado de Cornualles; taller interactivo de cocción.", lat: 20.13950, lng: -98.67050, icono: "ðŸ¥Ÿ", destacado: true },
];

// â”€â”€â”€â”€â”€ III. ESPACIOS DE IDENTIDAD Y MEMORIA â”€â”€â”€â”€â”€

export const ESPACIOS_IDENTIDAD: SitioPatrimonial[] = [
  { id: "IDE-01", nombre: "Panteón Inglés (1851)", categoria: "espacio-identidad", descripcion: "Tumbas orientadas a Europa; símbolo del mestizaje cultural.", lat: 20.13827, lng: -98.66704, icono: "ðŸª¦", destacado: true },
  { id: "IDE-02", nombre: "Galería Badillo", categoria: "espacio-identidad", descripcion: "Calle Iturbide 6. Repositorio fotográfico privado de la evolución de Real del Monte.", lat: 20.13985, lng: -98.67204, icono: "ðŸ“¸" },
  { id: "IDE-03", nombre: "Monumento a la 1ra Huelga en América", categoria: "monumento", descripcion: "Mural y monumento en la entrada principal; hito del derecho laboral mundial.", lat: 20.13824, lng: -98.67336, icono: "âœŠ", destacado: true },
];
...
export const HITOS_VISUALES: SitioPatrimonial[] = [
  ...
  { id: "VIS-03", nombre: "Callejón de las Leyendas del Fútbol", categoria: "hito-visual", descripcion: "Homenaje a la cuna del fútbol mexicano.", lat: 20.14045, lng: -98.67260, icono: "âš½" },
  { id: "VIS-04", nombre: "Callejón de los Artistas", categoria: "hito-visual", descripcion: "Pasaje con murales dedicados a la cinematografía nacional filmada en el territorio.", lat: 20.14040, lng: -98.67240, icono: "ðŸŽ¬" },
];
...
export const PATRIMONIO_NATURAL: SitioPatrimonial[] = [
  ...
  { id: "NAT-02", nombre: "Lienzo Charro Municipal", categoria: "naturaleza", descripcion: "En el corazón del Hiloche; cultura del caballo bajo microclima de montaña.", lat: 20.14260, lng: -98.68010, icono: "ðŸŽ" },
  { id: "NAT-03", nombre: "Peñas Cargadas", categoria: "naturaleza", descripcion: "Formaciones basálticas para rappel, escalada y fotografía.", lat: 20.12450, lng: -98.64600, icono: "ðŸª¨", destacado: true },
  { id: "NAT-04", nombre: "Ruta del Pulque (Tezoantla)", categoria: "naturaleza", descripcion: "Tinacales tradicionales y producción ancestral de aguamiel.", lat: 20.12576, lng: -98.64768, icono: "ðŸ¶" },
];
