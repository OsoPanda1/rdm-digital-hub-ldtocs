 ...
 * de Real del Monte, Hidalgo. Centro canÃ³nico: 20.1437, -98.6692.
 * Los offsets sitÃºan cada plataforma sobre un punto patrimonial relevante.
 */
export const LTOS_COORDINATES: Record<string, { lat: number; lng: number; anchor: string }> = {
  ...
  "real-del-monte-digital": { lat: 20.1409, lng: -98.6712, anchor: "PanteÃ³n InglÃ©s" },
  "real-del-monte-twin":    { lat: 20.1476, lng: -98.6655, anchor: "Cerro del JudÃ­o" },
  "real-del-monte-atlas":   { lat: 20.1391, lng: -98.6660, anchor: "Mirador del Hiloche" },
  "real-del-monte-elevated":{ lat: 20.1445, lng: -98.6720, anchor: "Parroquia AsunciÃ³n" },
  ...
  "rdm-digital-nodo-cero":  { lat: 20.1437, lng: -98.6692, anchor: "Nodo Cero Â· Plaza" },
};
