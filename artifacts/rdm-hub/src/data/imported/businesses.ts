...
export const FEDERATIONS = [
  ...
  { id: "gastronomica", name: "Gastronómica", icon: "ðŸ½ï¸", count: 3 },
  { id: "plateria", name: "Platería y Artesanía", icon: "ðŸ’", count: 2 },
  { id: "comercio", name: "Comercio y Servicios", icon: "ðŸª", count: 2 },
  { id: "guias", name: "Guías y Experiencias", icon: "ðŸ—ºï¸", count: 1 },
