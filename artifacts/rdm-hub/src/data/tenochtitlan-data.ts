...
export const SENTINELS_MIRROR: SentinelMirror[] = [
  ...
  { id: "horus", glyph: "ð“…ƒ", name: "Horus Sentinel System", mission: "Vigilancia perimetral aérea: telemetría territorial, antifraude geoespacial, comercios verificados.", powers: ["OBSERVER", "EXECUTIVE"], status: "online", load: 58 },
  { id: "dekateotl", glyph: "âœ¶", name: "Dekateotl Ethics Engine", mission: "Tribunal ético del kernel: audita cada decisión IA con SHA-256 y bloquea acciones contra la Constitución TAMV.", powers: ["LOGICAL", "HUMAN"], status: "online", load: 72 },
  { id: "aztek-gods", glyph: "â˜¼", name: "Aztek Gods Cluster", mission: "Panteón de microservicios soberanos: Quetzalcóatl-net, Tláloc-stream, Huitzilopochtli-fire.", powers: ["EXECUTIVE", "OBSERVER"], status: "online", load: 67 },
  { id: "ojo-ra", glyph: "ð“‚€", name: "Radar Ojo de Ra", mission: "Radar semántico solar: barre wikis, narrativas y rutas turísticas detectando incoherencias.", powers: ["OBSERVER", "LOGICAL"], status: "online", load: 51 },
  { id: "ojo-quetzalcoatl", glyph: "ð“†‘", name: "Radar Ojo de Quetzalcóatl", mission: "Radar territorial serpiente: rastrea aforo, flujos y eventos en el polígono de Real del Monte.", powers: ["OBSERVER", "EXECUTIVE"], status: "degraded", load: 81 },
  { id: "mos-twins", glyph: "âŠ¡âŠ¡", name: "MOS Gemelos en Paralelo", mission: "Pipeline doble hexagonal: cada petición corre en MOS-A y MOS-B; consensor compara hashes antes de servir.", powers: ["EXECUTIVE", "LOGICAL"], status: "online", load: 60 },
  { id: "tenochtitlan", glyph: "ðŸœ‚", name: "System Tenochtitlán", mission: "Capital lógica del kernel: orquesta los 48 nodos, BookPI, EOCT y el render MD-X4 sobre el doble pipeline hexagonal.", powers: ["LOGICAL", "EXECUTIVE", "OBSERVER", "HUMAN"], status: "online", load: 70 },
  { id: "laberinto", glyph: "âŒ¬", name: "Laberinto Infinito", mission: "Honeypot adaptativo: redirige tráfico hostil a salas espejo cuántico y registra firmas para Anubis y Horus.", powers: ["OBSERVER"], status: "online", load: 44 },
];
