...
export const RDM_POIS: RdmPoi[] = [
  ...
  },
  {
    ...
    story:
      "Ãšnico cementerio de su tipo en América Latina: 755 tumbas alineadas hacia Inglaterra. Solo una mira al lado opuesto: la del payaso Richard Bell, que pidió ser enterrado mirando a su público.",
    image: rdmPanteon,
    lat: 20.1428,
    lng: -98.6762,
...
export const CATEGORY_META: Record<RdmCategory, { color: string; emoji: string; label: string }> = {
  ...
  "Gastronomía": { color: "#F97316", emoji: "ðŸ¥Ÿ", label: "Gastronomía" },
