...
// Lírica de Asentamiento Urbanâ€‘Minero â€” Capítulo II del DOCUMENTO MAESTRO INTERCONECTADO DE SOBERANÍA DIGITAL
...
// Función sistémica: calibración del motor de análisis de Isabella AI ante jerga territorial y ritmos urbanosâ€‘mineros
...
export const deLaTocadaAlCanton: Cancion = {
  ...
  secciones: [
    {
      id: "intro",
      titulo: "Introducción â€” Llamado Serrano",
      versos: [
    ...
    {
      id: "verso-1",
      titulo: "Verso I â€” Crónica de Cantina",
      versos: [
    ...
    {
      id: "coro",
      titulo: "Coro â€” De la Tocada al Cantón",
      versos: [
    ...
    {
      id: "coro-2",
      titulo: "Coro II â€” Retorno al Cantón",
      versos: [
        "De la tocada al cantón, cantón",
        "Pánfilo Soto me llama, es mi rincón",
  ...
  metadatos: {
    ...
    estado: "composición abierta â€” letra canónica",
    funcion_sistemica: "calibración de Isabella AI ante jerga territorial y ritmos urbanosâ€‘mineros",
  },
};
