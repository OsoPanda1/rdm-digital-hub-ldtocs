...
La Constitución YUN define los principios inmutables de la arquitectura.
Estos principios no son recomendaciones: son reglas obligatorias que limitan y guían el diseño, la implementación y la operación de todos los sistemas que se ejecutan sobre YUN.
...
- Todos los secretos se gestionan por un sistema de gestión de secretos central.
...
La versión v1.0 entra en vigor en el momento en que TAMV Online y Nodo Cero adoptan YUN como arquitectura oficial.
Toda nueva versión debe especificar en qué fecha entra en vigencia y qué cambios introduce sobre la anterior.
