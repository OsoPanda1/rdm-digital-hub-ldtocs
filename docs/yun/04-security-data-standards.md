...
- Datos P0 se almacenan:
  - en dominios dedicados,
  - separados de datos menos sensibles.
- Fragmentación:
  - Separar atributos muy sensibles (ej. documentos, identificadores oficiales) en tablas o dominios específicos, con acceso reducido.
...
- La replicación de datos entre sistemas se realiza:
  - mediante eventos (CDC).
  - nunca con copias directas no controladas.
- Cachés:
  - Redis/Turso pueden almacenar datos menos sensibles y efímeros.
...
- Datos P0:
  - se borran o anonimizan cuando ya no son necesarios.
- Datos P1/P2:
  - se retienen según necesidades operativas y legales.
